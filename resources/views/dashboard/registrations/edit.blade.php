        ...
        <div class="col s12">
            ...
            <div class="card">
                <div class="card-content">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('dashboard.registrations.update', ['carRally' => $carRally, 'registration' => $registration]) }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
            ...
            <a class="grey-text right" href="/{{ $carRally->alias }}/panel/zgloszenia">&larr; Powrót do zgłoszeń</a>
        </div>
    </div>
</div>
@endsection
