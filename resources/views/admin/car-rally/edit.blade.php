...
@section('head-end')
    ...
    <script>
        tinymce.init({
            selector:'textarea#info, textarea#rules',
        ...
        <div class="col s8 offset-s2">
            ...
            <div class="card">
                <div class="card-content">
                    <form method="POST" action="{{ route('admin.car-rally.update', ['carRally' => $carRally]) }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        ...
                        <div class="input-field{{ $errors->has('alias') ? ' has-error' : '' }}">
                            ...
                            <input id="alias" type="text"  name="alias" value="{{ $carRally->alias }}" required data-length="30">
                        ...
                        <span class="grey-text">Informacje</span>
                        ...
                        <span class="grey-text">Regulamin</span>
                ...
                <a class="grey-text right" href="/administrator/zloty">&larr; Powrót do zlotów</a>
            </div>
        </div>
    </div>
</div>
